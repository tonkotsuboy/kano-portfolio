...
const AboutPageComponent: FC = () => (
  <div className={styles.about}>
    ...
    <p>
      ...
      <ExternalLink
        url="https://techfeed.io/people/@tonkotsuboy_com"
        linkText="TechFeed Pro公認エキスパート"
      />
    </p>
    <h2>書籍</h2>
    <ul>
    ...
    <ul>
      ...
      <li>
        <ExternalLink
          url="https://techfeed.io/people/@tonkotsuboy_com"
          linkText="TechFeed Pro"
        />
      </li>
      <li>
        <ExternalLink url="https://zenn.dev/tonkotsuboy_com" linkText="Zenn" />
      </li>
      <li>
        <ExternalLink
